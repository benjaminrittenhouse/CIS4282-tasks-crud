...
router.get("/listAllTasks", (req, res) => {
    try {
      const sqlGet = "SELECT task_id, task_name, task_desc, task_points, target_date, completion_date, assigned_web_user_id, first_name, last_name, cat_icon FROM db.tasks, db.web_user, db.categories"
